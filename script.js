...
function showRaiting(){
        ...
        let raitingList =  `<li id=firstPlace>Первое место - ${arr[0] ? arr[0] : ''} </li>
                            <li id=secondPlace>Второе место - ${arr[1] ? arr[1] : ''} </li>
                            <li id=thirdPlace>Третье место - ${arr[2] ? arr[2] : ''} </li> 
                            <li id=fourthPlace>Четвертое место - ${arr[3] ? arr[3] : ''} </li>
                            <li id=fifthPlace>Пятое место - ${arr[4] ? arr[4] : ''} </li>`
